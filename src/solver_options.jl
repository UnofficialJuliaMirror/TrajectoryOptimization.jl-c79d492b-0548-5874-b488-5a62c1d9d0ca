...
mutable struct SolverOptions
    ...
    function SolverOptions(;square_root=false,verbose=false,
        ...
        benchmark=false,solve_feasible=true,infeasible=false,unconstrained=false,λ_min=-1.0e16,λ_max=1.0e16,μ_max=1.0e16,μ1=1.0,γ=10.0,γ_no=1.0,τ=0.5,outer_loop_update=:uniform,ρ_initial=0.0,ρ_factor=1.6,ρ_max=1.0e10,ρ_min=1e-6)
