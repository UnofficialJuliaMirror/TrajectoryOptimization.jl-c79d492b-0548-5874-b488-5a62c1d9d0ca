...
mutable struct SolverOptions
    ...
    function SolverOptions(;constrained=false,minimum_time=false,infeasible=false,square_root=false,verbose=false,
        ...
        iterations_linesearch=15,R_infeasible=1.0e3,R_minimum_time=1.0,
        ...
        ρ_initial=0.0,ρ_factor=1.6,ρ_max=1.0e8,ρ_min=1e-6,regularization_type=:state,ρ_forwardpass=10.0,eigenvalue_scaling=2.0,eigenvalue_threshold=1e-8,use_static=false,live_plotting=false,dJ_zero_counter=10)
        ...
        use_static,live_plotting,dJ_zero_counter)
    end
end
